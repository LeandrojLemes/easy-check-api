...
// // app.use(
// //   cors({
// //     origin: "https://easy-check-api.onrender.com", 
...
// Rotas públicas
app.post("/login", _autenticacaoController.login.bind(_autenticacaoController));
app.post("/usuarios", _usuariosController.adicionar.bind(_usuariosController));
...
// Rotas protegidas
app.get("/usuarios", _usuariosController.listar.bind(_usuariosController));
app.put("/usuarios", _usuariosController.atualizar.bind(_usuariosController));
app.delete("/usuarios/:id", _usuariosController.excluir.bind(_usuariosController));

app.post("/clientes", _clienteController.adicionar.bind(_clienteController));
app.get("/clientes", _clienteController.listar.bind(_clienteController));
app.get("/clientes/:id", _clienteController.buscarPorId.bind(_clienteController));
app.put("/clientes/:id", _clienteController.atualizar.bind(_clienteController));
app.delete("/clientes/:id", _clienteController.excluir.bind(_clienteController));
